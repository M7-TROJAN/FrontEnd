...
بالنسبة لـ `let` و `const`، بيتم رفع التصريح لكن بتفضل المتغيرات في حاجة اسمها "Temporal Dead Zone" (المنطقة الميتة المؤقتة) لحد ما يوصل التنفيذ لسطر التعريف الفعلي. لو حاولت تستخدم المتغير قبل ما يتم تعيينه، هيحصل خطأ.
